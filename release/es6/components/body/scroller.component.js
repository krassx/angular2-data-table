...
import { Component, Input, ElementRef, Output, EventEmitter, ChangeDetectionStrategy, HostBinding } from '@angular/core';
export let ScrollerComponent = class ScrollerComponent {
    constructor(element) {
