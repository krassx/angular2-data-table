...
import { Component, Output, EventEmitter, Input, HostBinding, ViewChild, ElementRef, Renderer, ChangeDetectionStrategy } from '@angular/core';
import { translateXY, columnsByPin, columnGroupWidths, RowHeightCache } from '../../utils';
import { SelectionType } from '../../types';
import { ScrollerComponent } from './scroller.component';
export let DataTableBodyComponent = class DataTableBodyComponent {
      ...
      <datatable-scroller
        *ngIf="rows.length"
        ...
        <datatable-row-wrapper 
          *ngFor="let row of temp; let i = index; trackBy: trackByRowIndex"
